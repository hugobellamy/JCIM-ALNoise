...
filename = 'AID_1893_datatable.csv'
data = pd.read_csv(filename)
data = data.set_index('PUBCHEM_CID')
"""
mylist = simplified.index.to_list()[1:]
with open('lookup_data2.csv', 'w', newline='') as myfile:
     ...
     for word in mylist:
        try:
            ...
            print(word)
"""
chem_data = pd.read_csv('Structures_Pub2.csv')
...
act_dict = data['RESPONSE_VALUE_MEKK2MT'].to_dict()
...
fingerprints.to_csv('Real2_fingerprints.csv')
activity.to_csv('Real2_targets.csv')
